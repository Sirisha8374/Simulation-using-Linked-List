...
void bookSeat() {
    ...
    if (availableSeat != NULL) {
        ...
        printf("\n Seat %d has been booked for %s\n", availableSeat->seatNumber, name);
    } else {
        // All seats are booked, add to waiting list
        addToWaitingList(name);
        printf("\n All seats are booked. %s has been added to the waiting list.\n", name);
    }
}
...
void cancelSeat() {
    ...
    printf("\n Seat %d booking cancelled for %s\n", seatNum, cancelledName);
...
int main() {
    ...
    printf("\n System initialized with %d seats\n", numSeats);
